...
class UpdateFormDevice extends React.Component {
    constructor(props) {
        super(props);
    ...
    updateDevice(id, address, description, maxHours) {
        return API_DEVICE.updateDevice(id, address, description, maxHours, (result, status, error) => {
    ...
    handleSubmit = () => {
        ...
        const address = this.state.formControls.address.value;
        const maxHours = this.state.formControls.maxHours.value;
        this.updateDevice(id, address, description, maxHours);
    };
